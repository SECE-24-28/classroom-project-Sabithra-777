...
const API_BASE = "http://localhost:21000/api/v1";
...
const UserRequestsPage = () => {
  ...
  const adminId = "675d1a9ac5bb8a2e144ed4f7";
  ...
  const fetchRequests = async () => {
    setLoading(true);
    try {
      const { data } = await axios.get(`${API_BASE}/Admin/getRequests`, {
        params: { id: adminId },
      });
