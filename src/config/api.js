...
export const authAPI = {
  ...
  adminRegister: (adminData) =>
    api.post(API_ENDPOINTS.USER.ADMIN_SIGNUP, adminData),
  adminLogin: (credentials) =>
    api.post(API_ENDPOINTS.USER.ADMIN_LOGIN, credentials),
};

export const userAPI = {
  getAssignments: (userId) =>
    api.get("/User/assignments", { params: { userId } }),
  submitAssignment: (formData) =>
    api.post("/User/submitTest", formData, {
      headers: { "Content-Type": "multipart/form-data" },
    }),
  getUserSubmissions: (userId) =>
    api.get("/User/submissions", { params: { userId } }),
  createRequest: (requestData) => api.post("/User/createRequest", requestData),
};

export const adminAPI = {
  getPendingRequests: (adminId) =>
    api.get("/Admin/getRequests", { params: { id: adminId } }),
  ...
  getAssignmentByName: (assignmentName, adminId) =>
    api.get("/Admin/getAssignmentByName", {
